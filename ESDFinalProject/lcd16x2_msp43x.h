 ...
 ***************************************************************************************/
#define     _EN_PORT        2                   // default EN port - P1
#define     _EN_PIN         1                   // default EN pin  - P1.6
#define     _RS_PORT        2                   // default RS port - P1
#define     _RS_PIN         0                   // default RS pin  - P1.7

#define     _LCD_4BIT_PORT          7               // port used to data
#define     _LCD_DATA_BASE          0               // first low pin of 4 bit interface
#define     _LCD_4BIT_HIGH          0xFF            // 4 bits in high mode
...
#define     LCD_CMD_INIT_8BIT                       0x30    // initial value to change to 8bit mdoe
